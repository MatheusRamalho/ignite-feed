...
Uma página para postagem de comentários, com aplausos (curtidas).
...
Você pode visualizar o deploy do projeto na vercel através [desse link](https://ignite-feed-mat.vercel.app/).
...
```bash
git clone https://github.com/MatheusRamalho/ignite-feed
```
